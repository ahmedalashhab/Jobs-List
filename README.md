...
![Design preview for the Job listings with filtering coding challenge](public/images/design/desktop-preview.jpg)
...
Use the [data.json](src/assets/data.json) file to pull the data and then dynamically add the content. This would be perfect if you're looking to practice a JS library/framework like React, Vue, or Svelte.
